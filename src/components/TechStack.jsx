        ...
        <section className="relative bg-white py-20">
            ...
            {selectedTech && (
                ...
                >
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 'clamp(16px, 4vw, 24px)', flexDirection: 'column' }}>
                            <img
                                src={selectedTech.icon}
                                alt={selectedTech.name}
                                style={{ width: 'clamp(80px, 20vw, 96px)', height: 'clamp(80px, 20vw, 96px)', objectFit: 'contain', alignSelf: 'center' }}
                            />
                            <div style={{ flex: 1, width: '100%' }}>
                                <h3 style={{ fontSize: 'clamp(20px, 5vw, 30px)', fontWeight: 600, marginBottom: '8px', color: 'rgb(17, 17, 17)' }}>
                                    {selectedTech.name}
                                </h3>
                                <p style={{ fontSize: 'clamp(14px, 3vw, 16px)', color: 'rgb(107, 114, 128)', marginBottom: '16px' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    <div>
                                        ...
                                        <p style={{ fontSize: 'clamp(14px, 3vw, 16px)', color: 'rgb(31, 31, 31)' }}>
                                            {selectedTech.usage}
                                        </p>
                                    </div>
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12">
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(24px, 8vw, 48px)' }}>
                    <div style={{ textAlign: 'center' }}>
                        <h3 style={{ fontSize: 'clamp(24px, 6vw, 36px)', fontWeight: 500, marginBottom: '12px', color: 'rgb(17, 17, 17)' }}>
                            Tech Stack
                        </h3>
                        <p style={{ fontSize: 'clamp(14px, 3vw, 16px)', color: 'rgb(107, 114, 128)' }}>
